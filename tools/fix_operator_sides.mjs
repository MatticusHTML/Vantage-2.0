...
const CANONICAL = {
  ...
  Striker: "ATK", Thatcher: "ATK", Thermite: "ATK", Twitch: "ATK", Ying: "ATK", Denari: "ATK",
  Zofia: "ATK",
  Alibi: "DEF", Aruni: "DEF", Azami: "DEF", Bandit: "DEF", Castle: "DEF", Caveira: "DEF",
  Clash: "DEF", Doc: "DEF", Echo: "DEF", Ela: "DEF", Fenrir: "DEF", Zero: "DEF",
  Frost: "DEF", Goyo: "DEF", Jager: "DEF", Kaid: "DEF", Kapkan: "DEF", Lesion: "DEF",
  Maestro: "DEF", Melusi: "DEF", Mira: "DEF", Mozzie: "DEF", Mute: "DEF", Oryx: "DEF",
  Pulse: "DEF", Rook: "DEF", Sens: "DEF", Sentry: "DEF", Skopos: "DEF", Smoke: "DEF",
  Solis: "DEF", "Solid Snake": "DEF", Tachanka: "DEF", Thorn: "DEF", Thunderbird: "DEF",
