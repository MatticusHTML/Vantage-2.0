...
for (const line of readFileSync(path, "utf8").split("\n")) {
  if (!line.includes("May 31") || !line.includes("Operator") || !line.includes("Aruni")) continue;
  if (!line.includes("Matticus") && !line.includes("now the operators")) continue;
  ...
  for (const part of parts) {
    ...
    writeFileSync("tools/matticus_y11s1_paste.txt", full);
